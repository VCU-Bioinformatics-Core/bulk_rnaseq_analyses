...
# bulk RNA-seq DE pipeline (v1.5.4).
#
...
banner() {
  if have gum; then
    gum style --border double --margin "1 0" --padding "1 4" \
      ...
      "Bulk RNA-Seq Differential Expression" "bisrDE · v1.5.4 · VCU Massey BISR"
  else
    echo "======================================================="
    echo "  Bulk RNA-Seq DE Pipeline — bisrDE v1.5.4 (VCU Massey)"
    echo "======================================================="
  fi
}
